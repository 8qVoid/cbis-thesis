...
<div class="col-md-4"><label class="form-label">Contact Number</label><input name="contact_number" class="form-control js-contact-number" value="{{ old('contact_number', preg_replace('/\D+/', '', (string) $facility->contact_number)) }}" inputmode="numeric" pattern="\d*" maxlength="30" placeholder="09171234567"><small class="text-muted">Numbers only. Mobile or landline accepted.</small></div>
