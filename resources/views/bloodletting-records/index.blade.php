...
@php
    ...
    $canManageBloodlettingRecords = ! ($currentUser?->isCentralAdmin() ?? false) && ($currentUser?->can('manage bloodletting records') ?? false);
@endphp
<div class="d-flex justify-content-between align-items-end mb-3">
    <div>
        <h1 class="cbis-page-title mb-0">Bloodletting Records</h1>
        <p class="cbis-page-subtitle">Facility staff verification and findings records.</p>
    </div>
