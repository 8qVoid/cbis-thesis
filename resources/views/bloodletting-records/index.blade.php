@extends('layouts.app')
@section('content')
<div class="d-flex justify-content-between align-items-end mb-3"><div><h1 class="cbis-page-title mb-0">Bloodletting Records</h1><p class="cbis-page-subtitle">Medical technologist verification and findings records.</p></div><a href="{{ route('bloodletting-records.create') }}" class="btn btn-danger">Add Record</a></div>
