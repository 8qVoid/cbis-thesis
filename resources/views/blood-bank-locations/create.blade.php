...
<div class="col-md-6"><label class="form-label">Contact Number</label><input name="contact_number" class="form-control js-contact-number" inputmode="numeric" pattern="\d*" maxlength="30" placeholder="09171234567"><small class="text-muted">Numbers only. Mobile or landline accepted.</small></div>
