@extends('layouts.app')
@section('content')
<div class="d-flex justify-content-between align-items-end mb-3"><div><h1 class="cbis-page-title mb-0">Blood Releases</h1><p class="cbis-page-subtitle">Track blood usage and decrement inventory accurately.</p></div><a href="{{ route('blood-releases.create') }}" class="btn btn-danger">Record Release</a></div>
