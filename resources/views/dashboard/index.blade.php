...
@php
    $user = auth('web')->user();
    $canSeeDonors = $user?->can('manage donors') || $user?->can('view limited donors') || $user?->can('view detailed donors');
    $canSeeDonations = $user?->can('manage donation records');
    $canSeeReleases = $user?->can('view blood releases') || $user?->can('manage blood releases');
