@php
    ...
    $tabs = [
        ...
        ['label' => 'Inventory', 'route' => 'blood-inventory.index', 'show' => $isCentral || $user?->can('view inventory') || $user?->can('manage inventory')],
        ['label' => 'Releases', 'route' => 'blood-releases.index', 'show' => $isCentral || $user?->can('view blood releases') || $user?->can('manage blood releases')],
        ...
        ['label' => 'Reports', 'route' => 'reports.index', 'show' => ! $isCentral && $user?->can('manage inventory') && $user?->can('view reports')],
