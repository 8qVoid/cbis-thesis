...
<div class="col-md-4"><label class="form-label">Birth Date</label><input type="date" name="birth_date" class="form-control" required><small class="text-muted">Donor account can be created before 18; eligibility is blocked until age {{ \App\Support\DonationAgePolicy::MINIMUM_AGE }}.</small></div>
