            ...
            <div class="card-body">
                <form method="POST" action="{{ route('donor.register.store') }}" class="js-confirm-action" data-confirm-title="Check your information" data-confirm-message="Please make sure your name, birth date, blood type, email, mobile number, and address are correct before continuing." data-confirm-button="Continue Registration" data-confirm-variant="danger">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4"><label class="form-label">Birth Date</label><input id="birthDate" type="date" name="birth_date" class="form-control" required><small class="text-muted">You may create a donor account before 18, but you cannot donate blood until you are at least {{ \App\Support\DonationAgePolicy::MINIMUM_AGE }}.</small></div>
